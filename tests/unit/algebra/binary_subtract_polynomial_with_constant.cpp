...
int main()
{
  ...
  static_assert(linear_minus_constant[0] == -1 && linear_minus_constant[1] == 3);
  ...
  if constexpr (constant_minus_cubic[0] == -1 && constant_minus_cubic[0] == constant_minus_cubic(0) &&
                constant_minus_cubic(1) == -1 && (-2 - cubic - 1)[0] == -6 &&
